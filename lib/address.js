...
var address = {
    ...
    city: function() {
        ...
        switch (faker.random.number(4)) {
            case 0:
                ...
                break;
            case 1:
                result = K.get(faker, 'random.city_prefix') + " " + K.get(faker, 'random.first_name');
    ...
    streetName: function() {
        ...
        switch (faker.random.number(2)) {
            case 0:
                result = K.get(faker, 'random.last_name') + " " + K.get(faker, 'random.street_suffix');
                break;
            case 1:
                result = K.get(faker, 'random.first_name') + " " + K.get(faker, 'random.street_suffix');
                break;
        }
        return result;
    },
    ...
    brState: function(useAbbr) {
        return useAbbr ? K.get(faker, 'random.br_state_abbr') : K.get(faker, 'random.br_state');
    },

    ukCounty: function() {
        return K.get(faker, 'random.uk_county');
    },

    ukCountry: function() {
        return K.get(faker, 'random.uk_country');
    },

    usState: function(useAbbr) {
        return useAbbr ? K.get(faker, 'random.us_state_abbr') : K.get(faker, 'random.us_state');
